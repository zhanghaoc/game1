...
int main(int argc, char **argv) {
	...
	SDL_Window *window = SDL_CreateWindow(
		"gp23 game1: Haoxi's bizarre Adventure", //TODO: remember to set a title for your game!
		SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
		3*PPU466::ScreenWidth + 8, 3*PPU466::ScreenHeight + 8, //TODO: modify window size if you'd like
		SDL_WINDOW_OPENGL
